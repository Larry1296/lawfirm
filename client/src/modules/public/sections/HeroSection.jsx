...
export default function HeroSection() {
  return (
    <section className="relative min-h-screen overflow-hidden bg-[#050816] flex items-center justify-center px-4 sm:px-6 lg:px-10 py-10">
      {/* Background Glow */}
      ...
      <motion.div
        ...
        className="relative w-full max-w-7xl min-h-[88vh] rounded-[32px] overflow-hidden"
        style={{
          boxShadow: `
      ...
      >
        {/* 3D Outer Border */}
        <div className="absolute inset-0 rounded-[32px] p-[2px] bg-gradient-to-br from-white/20 via-blue-400/20 to-indigo-500/20">
          {/* Image Container */}
